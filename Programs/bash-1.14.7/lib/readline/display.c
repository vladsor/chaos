...
DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE,"Ret: %p\n", r);
...
DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE,"%s: %p\n", __FUNCTION__, local_prompt);
...
DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE,"%s: %p, %p\n", __FUNCTION__, 
    rl_display_prompt, local_prompt);
