...
<tagfile>
  <compound kind="file">
    ...
    <path>/root/Chaos/Enviroments/System/ia32/</path>
    <filename>cpu__common_8h</filename>
  </compound>
  <compound kind="file">
    <name>cr0.h</name>
    <path>/root/Chaos/Enviroments/System/ia32/Registers/</path>
  ...
  <compound kind="file">
    ...
    <path>/root/Chaos/Enviroments/System/ia32/Segmentation/</path>
  ...
  <compound kind="file">
    <name>page.h</name>
    <path>/root/Chaos/Enviroments/System/ia32/Paging/</path>
    ...
    <member kind="typedef">
      <type>page_number_t *</type>
      <name>p_page_number_t</name>
      <anchor>ga1</anchor>
      <arglist></arglist>
    </member>
  </compound>
  ...
  <compound kind="file">
    ...
    <includes id="selector_8h" name="selector.h" local="yes">Segmentation/selector.h</includes>
    ...
    <includes id="idt_8h" name="idt.h" local="yes">Segmentation/idt.h</includes>
  </compound>
  <compound kind="file">
    <name>selector.h</name>
    <path>/root/Chaos/Enviroments/System/ia32/Segmentation/</path>
    <filename>selector_8h</filename>
  ...
  <compound kind="file">
    ...
    <includes id="cr0_8h" name="cr0.h" local="yes">Registers/cr0.h</includes>
    <includes id="cr2_8h" name="cr2.h" local="yes">Registers/cr2.h</includes>
    <includes id="cr3_8h" name="cr3.h" local="yes">Registers/cr3.h</includes>
    <includes id="cr4_8h" name="cr4.h" local="yes">Registers/cr4.h</includes>
  </compound>
  <compound kind="file">
    <name>tss.h</name>
    <path>/root/Chaos/Enviroments/System/ia32/Segmentation/</path>
