/* $chaos: gdb.c,v 1.5 2002/10/15 18:14:34 per Exp $ */
...
static int getDebugChar (void)
{
    ...
    ch = port_uint8_in (i386at_serial_iobase + 0);
...
{
    idt_setup_interrupt_gate (exception, SELECTOR_KERNEL_CODE, 
        (address_t) address, PRIVILEGE_LEVEL_USER);
};
...
extern void handle_exception (int exceptionVector) NORETURN;
