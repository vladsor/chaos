...
{
    { CPU_VENDOR_UNKNOWN,         VENDOR_UNKNOWN_STRING },
    { CPU_VENDOR_AMD,             VENDOR_AMD_STRING },
    { CPU_VENDOR_INTEL,           VENDOR_INTEL_STRING },
    { CPU_VENDOR_CYRIX,           VENDOR_CYRIX_STRING },
    { CPU_VENDOR_CENTAUR,         VENDOR_CENTAUR_STRING },
    { CPU_VENDOR_UMC,             VENDOR_UMC_STRING },
    { CPU_VENDOR_NEXGEN,          VENDOR_NEXGEN_STRING },
    { CPU_VENDOR_RISETECHNOLOGY,  VENDOR_RISETECHNOLOGY_STRING },
    { CPU_VENDOR_TRANSMETA,       VENDOR_TRANSMETA_STRING }
};
...
{
  { 0,LAST, CPU_VENDOR_UNKNOWN,	CPU_TYPE_UNKNOWN_8086 },
};

static cpu_family_record family1[] =
{
  { 0,LAST, CPU_VENDOR_UNKNOWN,	CPU_TYPE_UNKNOWN_80186 },
};

static cpu_family_record family2[] =
{
  { 0,LAST, CPU_VENDOR_UNKNOWN,	CPU_TYPE_UNKNOWN_80286 },
};

static cpu_family_record family3[] =
{
  { 0,LAST, CPU_VENDOR_UNKNOWN,	CPU_TYPE_UNKNOWN_80386 },
};

static cpu_family_record family4[] =
{
  { 2,   2, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_486SX },
  { 3,   3, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_486DX2 },
  { 4,   4, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_486SL },
  { 5,   5, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_486SX2 },
  { 7,   7, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_486DX2 },
  { 8,   9, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_486DX4 },
  { 0,LAST, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_486 },

  { 3,   7, CPU_VENDOR_AMD,		CPU_TYPE_AMD_486DX2 },
  { 8,   9, CPU_VENDOR_AMD,		CPU_TYPE_AMD_486DX4 },
  {0xE,0xF, CPU_VENDOR_AMD,		CPU_TYPE_AMD_5x86 },

  { 0,LAST, CPU_VENDOR_AMD,		CPU_TYPE_AMD_486 },

  { 4,   4, CPU_VENDOR_CYRIX,	CPU_TYPE_Cyrix_MediaGX },
  { 0,LAST, CPU_VENDOR_CYRIX,	CPU_TYPE_Cyrix_5x86 },

  { 1,   1, CPU_VENDOR_UMC,		CPU_TYPE_UMC_U5D },
  { 2,   2, CPU_VENDOR_UMC,		CPU_TYPE_UMC_U5S },

  { 0,LAST,CPU_VENDOR_UNKNOWN,	CPU_TYPE_UNKNOWN_80486 },
};

static cpu_family_record family5[] =
{
  { 0,   3, CPU_VENDOR_AMD,		CPU_TYPE_AMD_K5 },
  { 7,   7, CPU_VENDOR_AMD,		CPU_TYPE_AMD_K6 },
  { 8,   8, CPU_VENDOR_AMD,		CPU_TYPE_AMD_K6_2 },
  { 9,   9, CPU_VENDOR_AMD,		CPU_TYPE_AMD_K6_3 },
  { 0,LAST, CPU_VENDOR_AMD,		CPU_TYPE_UNKNOWN_AMD },

  { 0,   8, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_Pentium },
  { 0,LAST, CPU_VENDOR_INTEL,	CPU_TYPE_UNKNOWN_INTEL_Pentium },

  { 4,   4, CPU_VENDOR_CYRIX,	CPU_TYPE_Cyrix_MediaGXm },
  { 0,LAST, CPU_VENDOR_CYRIX,	CPU_TYPE_Cyrix_6x86 },

  { 4,   4, CPU_VENDOR_CENTAUR,    CPU_TYPE_Centaur_C6 },
  { 8,   8, CPU_VENDOR_CENTAUR,    CPU_TYPE_Centaur_C2 },
  { 9,   9, CPU_VENDOR_CENTAUR,    CPU_TYPE_Centaur_C3 },

  { 0,   2, CPU_VENDOR_RISETECHNOLOGY, CPU_TYPE_Rise_mP6 },

  { 0,LAST, CPU_VENDOR_UNKNOWN,	CPU_TYPE_UNKNOWN_80586 },
};

static cpu_family_record family6[] =
{
  { 0,   2, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_Pentium_Pro },
  { 3,   6, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_Pentium_II },
  { 7,   9, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_Pentium_III },
  { 0,LAST, CPU_VENDOR_INTEL,	CPU_TYPE_UNKNOWN_INTEL_P6 },

  { 0,LAST, CPU_VENDOR_AMD,		CPU_TYPE_AMD_Athlon },

  { 0,   0, CPU_VENDOR_CYRIX,	CPU_TYPE_Cyrix_6x86MX },

  { 0,LAST, CPU_VENDOR_UNKNOWN,	CPU_TYPE_UNKNOWN_80686 },
};

static cpu_family_record family7[] =
{
  { 0,LAST, CPU_VENDOR_INTEL,	CPU_TYPE_INTEL_Pentium_4 },
}
;
...
static void cpu_id_process (cpu_info_t *cpu_info)
{
    ...
    cpu_info->vendor_string[CPU_VENDOR_STRING_LENGTH] = 0;
