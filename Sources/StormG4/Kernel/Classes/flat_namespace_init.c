...
static flat_namespace_interface_table_t table = 
{
    &flat_namespace_add_entry,
    &flat_namespace_get_entry,
    &flat_namespace_delete_entry,
    &flat_namespace_list_entries
};

/* Main function. */

interface_reference_t flat_namespace_init (void)
{
    return flat_namespace_interface_register (&table);
}
