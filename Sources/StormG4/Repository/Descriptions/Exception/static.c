...
exception_reference_t exception_create_static (p_exception_t exception)
{
    p_exception_t exception_reference;
    ...
    return (exception_reference_t) exception_reference;    
}

void exception_destroy_static (exception_reference_t exception_reference)
{
    p_exception_t exception = (p_exception_t) exception_reference;

#if defined (SECURITY_ENABLED)
    exception_destroy_security_check (exception_reference);
#endif
