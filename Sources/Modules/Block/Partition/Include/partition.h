...
} partition_entry_t PACKED;

typedef partition_entry_t * p_partition_entry_t;
...
extern return_t scan_for_partitions (handle_reference_t generic, wchar_t *name);
