/* $chaos: md5.c,v 1.3 2002/10/23 07:28:38 per Exp $ */
...
/* MD5 block update operation. Continues an MD5 message-digest
   ...
   context. */
static void checksum_md5_update (checksum_md5_context_type *context,
                                 const uint8_t *input, 
...
static void checksum_md5_final (checksum_md5_digest_type *digest,
                                checksum_md5_context_type *context)
{
    ...
    memory_set_uint8 ((uint8_t *) context, 0, sizeof (checksum_md5_context_type));
}
...
#define S44 21
    ...
    /* Zeroize sensitive information. */
    memory_set_uint8 ((uint8_t *) x, 0, sizeof (x));
}

/* Wrapper function that does everything. */
return_t checksum_md5 (void *input, unsigned int length,
