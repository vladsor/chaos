        ...
        switch (format_string[input_index])
        {
            ...
            case '%':
            {
                    ...
                    format_string[input_index] <= '9')
                {
                    ...
                    string_to_number (&format_string[input_index], 
                                      &field_width,
                                      &characters);
                ...
                switch (format_string[input_index])
                {
                    ...
                    case 'C':
                    {
                        wchar_t character = va_arg (arguments, int);
                    ...
                    case 'S':
                    {
                        wchar_t *temporary_string = va_arg (arguments, 
                                                            wchar_t *);
                        int index = 0;
                        int length;
                        ...
                        while (temporary_string[index] != L'\0' && 
                               index < precision)
                        {
                            if (temporary_string[index] < UINT8_MAX)
                            {
                                output[output_index++] = 
                                    (char) temporary_string[index++];
                            }
                            else
                            {
                                output[output_index++] = '?';
                    ...
                    case 'd':
                    {
                        ...
                        flags |= STRING_SIGN;
                        number_to_string (string, number, 10, field_width, 
                                          precision, flags);
                    ...
                    case 'u':
                    {
                        ...
                        number_to_string (string, va_arg (arguments, unsigned),
                    ...
                    case 'p':
                    {
                        ...
                        number_to_string (string, UINT32_HIGH_UINT16 (pointer),
                                          16, 4, 4, flags);
                        ...
                        number_to_string (string, UINT32_LOW_UINT16 (pointer), 
                                          16, 4, 4, flags);
    ...
    while (*format_string != 0) 
    {
        ...
        else 
        {
            ...
            switch (*format_string) 
            {
                ...
                case 'd':
                {
                    input = string_scn (input, (char *) "1234567890-+");
                ...
                {
                    input = string_scn (input, (char *) "1234567890");
                    string_to_unsigned_int (input, (unsigned int *) &n2, 10, 
                                            &count);
                    input += count;
                ...
                case 'x':
                {
                    input = string_scn (input, 
                                        (char *) "1234567890xabcdefABCDEF");
                    string_to_unsigned_int (input, (unsigned int *) &n2, 16, 
                                            &count);
                    input += count;
                ...
                case 'e':
                {
                    input = string_scn (input, (char *) "1234567890.e+-");
