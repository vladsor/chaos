	  ...
	  case 'c':
	  {
	    ...
	    break;
          ...
          case 'p':
          {
            ...
            number_to_string (string, UINT32_HIGH_UINT16 (pointer), 16, 4, 4, 
                flags);
            ...
            number_to_string (string, UINT32_LOW_UINT16 (pointer), 16, 4, 4, 
                flags);
	  ...
	  *c_ptr = 0;
          ...
          if (!suppress)
	  {
		...
		*n2s = (short) n2;
        ...
        case 'x':
        {
          input = string_scn (input, (char *) "1234567890xabcdefABCDEF");
