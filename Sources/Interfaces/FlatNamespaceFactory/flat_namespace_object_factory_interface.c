    ...
    sequence_t parameters_in UNUSED)
{
    ...
    create = (p_flat_namespace_object_factory_create_t) (address_t) function;
...
interface_reference_t flat_namespace_object_factory_interface_register (
    p_flat_namespace_object_factory_interface_table_t table)
{
    ...
    interface_description = interface_description_register (
        INTERFACE_FLAT_NAMESPACE_OBJECT_FACTORY_ID,
        L"flat_namespace_object_factory",
