    ...
    sequence_t parameters_in)
{
    ...
    create = (p_storm_program_factory_create_t) (address_t) function;
...
interface_reference_t storm_program_factory_interface_register (
    p_storm_program_factory_interface_table_t table)
{
    ...
    interface_description = interface_description_register (
        INTERFACE_STORM_PROGRAM_FACTORY_ID,
        L"storm_program_factory",
