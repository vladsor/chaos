...
uint8_t handle_event (void)
{
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE, "Start handling event.\n");
...
int controller_wait_for_input (void)
{
  ...
  DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE, "Waiting for input...\n");
...
int controller_read_data (void)
{
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE, "Reading controller data...\n");
