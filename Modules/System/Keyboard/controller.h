...
#define controller_read_input() \
    port_uint8_in (CONTROLLER_REGISTER_DATA)
    
#define controller_read_status() \
    port_uint8_in (CONTROLLER_REGISTER_STATUS)
    
#define controller_write_output(value) \
    port_uint8_out (CONTROLLER_REGISTER_DATA, value)
    
#define controller_write_command(value) \
    port_uint8_out (CONTROLLER_REGISTER_CONTROL, value)
