/* $Id: ipv4.h,v 1.1.1.1 2000/09/26 19:08:14 plundis Exp $ */
...
typedef struct
{
  void (*function)(ipv4_interface_type *interface,
                   network_ethernet_header_type *ethernet_header, int length,
...
extern void ipv4_ethernet_header_create
  (void *destination, void *source, u16 protocol_type,
   network_ethernet_header_type *buffer);

extern u16 ipv4_checksum (u16 *data, unsigned int length);
extern void ipv4_address_to_string (char *string, u32 ipv4_address);
