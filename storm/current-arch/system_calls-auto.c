...
const system_call_type system_call[] =
{
  ...
  { SYSTEM_CALL_EVENT_QUEUE_CREATE, wrapper_event_queue_create, 2 },
  { SYSTEM_CALL_EVENT_QUEUE_DESTROY, wrapper_event_queue_destroy, 1 },
  { SYSTEM_CALL_EVENT_QUEUE_FLUSH, wrapper_event_queue_flush, 1 },
  { SYSTEM_CALL_EVENT_QUEUE_GET_INFO, wrapper_event_queue_get_info, 2 },
  { SYSTEM_CALL_EVENT_QUEUE_REGISTER_LISTENER, wrapper_event_queue_register_listener, 2 },
  { SYSTEM_CALL_EVENT_QUEUE_UNREGISTER_LISTENER, wrapper_event_queue_unregister_listener, 1 },
  { SYSTEM_CALL_EVENT_QUEUE_GENERATE_EVENT, wrapper_event_queue_generate_event, 3 },
  { SYSTEM_CALL_EVENT_QUEUE_WAIT_EVENT, wrapper_event_queue_wait_event, 3 },
};