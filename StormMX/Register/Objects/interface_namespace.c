...
#define DEBUG_MODULE_NAME "GlobalNamespace"
...
static return_t flat_namespace_create (flat_namespace_t *namespace)
{
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE1,
        "%s::%s (%p)\n",
        DEBUG_MODULE_NAME, __FUNCTION__, namespace);
        
    memory_set_uint8 ((uint8_t *) namespace, 0, sizeof (flat_namespace_t));
    ...
    char *name, handle_t *handle)
{
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE1,
        "%s::%s (%p, %s, %p)\n",
        DEBUG_MODULE_NAME, __FUNCTION__, namespace, name, handle);
    ...
    memory_set_uint8 ((uint8_t *) entry, 0, sizeof (flat_name_t));
    ...
    flat_namespace_t *namespace, char *name, handle_t *namespace_handle)
{
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE1,
        "%s::%s (%p, %s, %p)\n",
        DEBUG_MODULE_NAME, __FUNCTION__, namespace, name, namespace_handle);
    ...
    char *name, flat_namespace_t *child_namespace)
{
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE1,
        "%s::%s (%p, %s, %p)\n",
        DEBUG_MODULE_NAME, __FUNCTION__, namespace, name, child_namespace);
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE2,
        "%s::%s Adding %p to %p storage...\n",
        DEBUG_MODULE_NAME, __FUNCTION__, entry, namespace->names_table);
    ...
    if (entry != NULL)
    {
        if (entry->type == NAME_TYPE_OBJECT)
        {
            DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE2,
                ...
                DEBUG_MODULE_NAME, __FUNCTION__, &entry->handle, &entry->handle.class);
    ...
    char *name, flat_namespace_t **child)
{
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE1,
        "%s::%s (%p, %s, %p)\n",
        DEBUG_MODULE_NAME, __FUNCTION__, namespace, name, child);

    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE1,
        "%s::%s Names table: %p.\n",
        DEBUG_MODULE_NAME, __FUNCTION__, namespace->names_table);
...
void namespace_bind (context_t *context, char *name, handle_t *handle)
{
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE,
        "%s::%s (\"%s\", %p)\n",
        DEBUG_MODULE_NAME, __FUNCTION__, name, handle);
        ...
        next_name != NULL && next_name[0] != '\0')
    {
        ...
        DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE1,
            "%s::%s (%s, %s, %s)\n",
            DEBUG_MODULE_NAME, __FUNCTION__, current_name, element_name, next_name);
        ...
        if (return_value == NAMESPACE_RETURN_NOT_NAMESPACE)
        {
                ...
                if (return_value != STORM_RETURN_SUCCESS)
                {
                    DEBUG_PRINT (DEBUG_LEVEL_ERROR,
                        ...
                        DEBUG_MODULE_NAME, __FUNCTION__, name, element_name);
    ...
    handle_t *namespace_handle)
{
    ...
    DEBUG_PRINT (DEBUG_LEVEL_INFORMATIVE,
        "%s::%s (\"%s\", %p)\n",
        DEBUG_MODULE_NAME, __FUNCTION__, name, namespace_handle);
