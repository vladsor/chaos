...
return_t io_port_init (int argc UNUSED, char *argv[] UNUSED)
{
    return STORM_RETURN_SUCCESS;
}

/* Register a port range. */
return_t io_port_register (unsigned int start, size_t ports, 
    char *description)
{
    return STORM_RETURN_SUCCESS;
}
...
return_t io_port_unregister (unsigned int start)
{
    return STORM_RETURN_SUCCESS;
}
