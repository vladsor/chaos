...
/* Abstract: Event library return values. */
...
#ifndef __LIBRARY_EVENT_RETURN_VALUES__
#define __LIBRARY_EVENT_RETURN_VALUES__

enum
{
  /* The function call completed successfully. */

  EVENT_RETURN_SUCCESS,
