/* $Id: file.c,v 1.2 2000/09/30 10:28:15 plundis Exp $ */
   ...
   file_directory_entry_read_type *directory_entry)
{
  ...
  message_parameter.message_class = IPC_VIRTUAL_FILE_SYSTEM_DIRECTORY_ENTRY_READ;
   ...
   file_verbose_directory_entry_type *directory_entry)
{
  ...
  message_parameter.protocol = IPC_PROTOCOL_VIRTUAL_FILE_SYSTEM;
  message_parameter.message_class = IPC_VIRTUAL_FILE_SYSTEM_FILE_GET_INFO;
  message_parameter.data = directory_entry;
  message_parameter.block = TRUE;
                       ...
                       file_handle_type *handle)
{
  ...
  message_parameter.protocol = IPC_PROTOCOL_VIRTUAL_FILE_SYSTEM;
  message_parameter.message_class = IPC_VIRTUAL_FILE_SYSTEM_FILE_OPEN,
                       ...
                       void *buffer)
{
  ...
  message_parameter.protocol = IPC_PROTOCOL_VIRTUAL_FILE_SYSTEM;
  message_parameter.message_class = IPC_VIRTUAL_FILE_SYSTEM_FILE_READ,
