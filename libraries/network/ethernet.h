...
typedef struct
{
  u8 destination_address[NETWORK_ETHERNET_ADDRESS_LENGTH];
  u8 source_address[NETWORK_ETHERNET_ADDRESS_LENGTH];
  u16 protocol_type;
  u8 data[0];
} __attribute__ ((packed)) network_ethernet_header_type;
