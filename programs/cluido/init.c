/* $Id: init.c,v 1.3 2000/09/30 10:28:15 plundis Exp $ */
...
ipc_structure_type network_structure;
...
int main (void)
{
  ...
  if (network_init (&network_structure, &empty_tag) == NETWORK_RETURN_SUCCESS)
  {
    has_net = TRUE;
    network_host_name_get (&network_structure, host_name);
  }
