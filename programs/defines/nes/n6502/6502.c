/***********************************************************/
/**                                                       **/
/**         6502 emulator by Neil Corlett                 **/
/**                                                       **/
/**         Modified by Yoyo to fit Little John           **/
/**                                                       **/
/**         Still some bugs to fix, test Radracer         **/
/**                                                       **/
/**         Last update on 4th Mai 2000, 02:01            **/
/**                                                       **/
/**         Fix cpu cycles with Marat Fayzullin ones      **/
/**                                                       **/
/***********************************************************/
...
void init6502()
{
  int i;
      ...
      for (i=0;i<256;i++) ticks[i]=Cycles[i];
}
