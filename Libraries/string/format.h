...
#ifndef __LIBRARY_STRING_FORMAT_H__
#define __LIBRARY_STRING_FORMAT_H__
 ...
 * @return
 */
extern int string_scan (char *input, char *format_string, ...) 
 ...
 * @return
 */
extern int string_scan_va (char *input, char *format_string, va_list arguments);
 ...
 * @return
 */
//extern unsigned int string_split (char *string, char **pointers);
