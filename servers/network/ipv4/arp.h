/* $Id: arp.h,v 1.1.1.1 2000/09/26 19:08:14 plundis Exp $ */
...
typedef struct
{
  ...
  u16 opcode;
  u8 sender_hardware_address[NETWORK_ETHERNET_ADDRESS_LENGTH];
  u32 sender_protocol_address;
  u8 target_hardware_address[NETWORK_ETHERNET_ADDRESS_LENGTH];
