/* $Id: 3c509.c,v 1.4 2000/10/16 21:00:05 plundis Exp $ */
...
/* Partially based on 3c509.c: A 3c509 EtherLink3 ethernet driver for
   Linux, Written 1993-1998 by Donald Becker. */
...
static bool etherlink3_open (device_type *device)
{
  ...
  if (system_thread_create () == SYSTEM_RETURN_THREAD_NEW)
  {
    ...
    memory_allocate ((void **) &device->input_buffer, 2048);
...
#endif
      {
        ...
        if (etherlink3_debug > 4)
        {
          log_print_formatted 
            (&log_structure, LOG_URGENCY_DEBUG, 
             ...
             ((network_ethernet_header_type *) device->input_buffer)->source_address[0],
             ((network_ethernet_header_type *) device->input_buffer)->source_address[1],
             ((network_ethernet_header_type *) device->input_buffer)->source_address[2],
             ((network_ethernet_header_type *) device->input_buffer)->source_address[3],
             ((network_ethernet_header_type *) device->input_buffer)->source_address[4],
             ((network_ethernet_header_type *) device->input_buffer)->source_address[5],
             ((network_ethernet_header_type *) device->input_buffer)->destination_address[0],
             ((network_ethernet_header_type *) device->input_buffer)->destination_address[1],
             ((network_ethernet_header_type *) device->input_buffer)->destination_address[2],
             ((network_ethernet_header_type *) device->input_buffer)->destination_address[3],
             ((network_ethernet_header_type *) device->input_buffer)->destination_address[4],
             ((network_ethernet_header_type *) device->input_buffer)->destination_address[5],
             system_byte_swap_u16 (((network_ethernet_header_type *) device->input_buffer)->protocol_type));
        }
        ...
        {          
          if (device->target[n].protocol_type ==
              ((network_ethernet_header_type *) device->input_buffer)->protocol_type)
          {
