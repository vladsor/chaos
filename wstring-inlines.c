...
wchar_t * wstring_append (wchar_t *destination, const char *source)
{
...
wchar_t wstring_compare_max (const char *cs, const char *ct, unsigned int count)
{
...
{
    const wchar_t *pointer = string + string_length (string);
...
wchar_t * wstring_find_substring (const wchar_t *string, const wchar_t *substring)
{
