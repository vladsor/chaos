...
enum 
{
  ...
  /* The requested event's queue was not available. */

  STORM_RETURN_EVENT_QUEUE_UNAVAILABLE,

  STORM_RETURN_EVENT_TOO_LARGE,

  STORM_RETURN_EVENT_QUEUE_NO_READERS,

  STORM_RETURN_EVENT_QUEUE_TIME_OUT,
