...
const system_call_type system_call[] =
{
  ...
  { SYSTEM_CALL_MEMORY_ALLOCATE, wrapper_memory_allocate, 2 },
  ...
  { SYSTEM_CALL_EVENT_QUEUE_CREATE, wrapper_event_queue_create, 4 },
  { SYSTEM_CALL_EVENT_QUEUE_DESTROY, wrapper_event_queue_destroy, 1 },
  { SYSTEM_CALL_EVENT_QUEUE_FLUSH, wrapper_event_queue_flush, 1 },
  { SYSTEM_CALL_EVENT_QUEUE_SEND, wrapper_event_queue_send, 2 },
  { SYSTEM_CALL_EVENT_QUEUE_RECEIVE, wrapper_event_queue_receive, 2 },
};
